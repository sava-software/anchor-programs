...
public record LendingAccountBorrowEvent(AccountEventHeader header,
                                        PublicKey bank,
                                        PublicKey mint,
                                        long amount) implements Borsh {

  public static LendingAccountBorrowEvent read(final byte[] _data, final int offset) {
    ...
    return new LendingAccountBorrowEvent(header,
                                         bank,
                                         mint,
                                         amount);
  }
