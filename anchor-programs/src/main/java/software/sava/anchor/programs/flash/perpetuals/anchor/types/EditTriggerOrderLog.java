...
public record EditTriggerOrderLog(PublicKey owner,
                                  PublicKey market,
                                  long price,
                                  int priceExponent,
                                  long sizeAmount,
  ...
  public static EditTriggerOrderLog read(final byte[] _data, final int offset) {
    ...
    return new EditTriggerOrderLog(owner,
                                   market,
                                   price,
                                   priceExponent,
                                   sizeAmount,
