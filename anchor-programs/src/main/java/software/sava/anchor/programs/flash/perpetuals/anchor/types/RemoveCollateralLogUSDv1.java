...
public record RemoveCollateralLogUSDv1(PublicKey owner,
                                       PublicKey market,
                                       long tradeId,
  ...
  public static RemoveCollateralLogUSDv1 read(final byte[] _data, final int offset) {
    ...
    return new RemoveCollateralLogUSDv1(owner,
                                        market,
                                        tradeId,
                                        collateralPrice,
