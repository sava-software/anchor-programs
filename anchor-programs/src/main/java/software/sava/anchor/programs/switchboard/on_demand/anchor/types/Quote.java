...
public record Quote(// The address of the signer generated within an enclave.
  ...
  public int write(final byte[] _data, final int offset) {
    ...
    i += 8;
    i += Borsh.writeArray(quoteRegistry, _data, i);
    i += Borsh.writeArray(registryKey, _data, i);
    i += Borsh.writeArray(secp256k1Signer, _data, i);
    lastEd25519Signer.write(_data, i);
    i += 32;
    i += Borsh.writeArray(lastSecp256k1Signer, _data, i);
    putInt64LE(_data, i, lastRotateSlot);
    i += 8;
    i += Borsh.writeArray(guardianApprovers, _data, i);
