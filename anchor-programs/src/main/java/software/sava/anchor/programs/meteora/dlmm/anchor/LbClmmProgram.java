...
import software.sava.anchor.programs.meteora.dlmm.anchor.types.AddLiquiditySingleSidePreciseParameter2;
import software.sava.anchor.programs.meteora.dlmm.anchor.types.BaseFeeParameter;
...
import software.sava.anchor.programs.meteora.dlmm.anchor.types.RebalanceLiquidityParams;
...
public final class LbClmmProgram {
  ...
  public record DecreasePositionLengthIxData(Discriminator discriminator, int lengthToRemove, int side) implements Borsh {  
    ...
    public static DecreasePositionLengthIxData read(final byte[] _data, final int offset) {
      if (_data == null || _data.length == 0) {
        return null;
      }
      final var discriminator = createAnchorDiscriminator(_data, offset);
  ...
  public static Instruction forIdlTypeGenerationDoNotCall(final AccountMeta invokedLbClmmProgramMeta, final PublicKey dummyZcAccountKey, final DummyIx ix) {
    final var keys = List.of(
  ...
  public record ForIdlTypeGenerationDoNotCallIxData(Discriminator discriminator, DummyIx ix) implements Borsh {  
    ...
    public static ForIdlTypeGenerationDoNotCallIxData read(final byte[] _data, final int offset) {
      if (_data == null || _data.length == 0) {
        return null;
      }
      final var discriminator = createAnchorDiscriminator(_data, offset);
  ...
  public record IncreasePositionLengthIxData(Discriminator discriminator, int lengthToAdd, int side) implements Borsh {  
    ...
    public static IncreasePositionLengthIxData read(final byte[] _data, final int offset) {
      if (_data == null || _data.length == 0) {
        return null;
      }
      final var discriminator = createAnchorDiscriminator(_data, offset);
  ...
  public record RebalanceLiquidityIxData(Discriminator discriminator, RebalanceLiquidityParams params, RemainingAccountsInfo remainingAccountsInfo) implements Borsh {  

    public static RebalanceLiquidityIxData read(final Instruction instruction) {
      return read(instruction.data(), instruction.offset());
    }

    public static RebalanceLiquidityIxData read(final byte[] _data, final int offset) {
      if (_data == null || _data.length == 0) {
        return null;
      }
      final var discriminator = createAnchorDiscriminator(_data, offset);
    ...
    @Override
    public int l() {
      return 8 + Borsh.len(params) + Borsh.len(remainingAccountsInfo);
    }
  }
  ...
  public record SetPairStatusPermissionlessIxData(Discriminator discriminator, int status) implements Borsh {  
    ...
    public static SetPairStatusPermissionlessIxData read(final byte[] _data, final int offset) {
      if (_data == null || _data.length == 0) {
        return null;
      }
      final var discriminator = createAnchorDiscriminator(_data, offset);
