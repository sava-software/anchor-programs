...
public record ExecuteTriggerOrderLog(PublicKey owner,
                                     PublicKey market,
                                     long entryPrice,
  ...
  public static final int BYTES = 206;

  public static ExecuteTriggerOrderLog read(final byte[] _data, final int offset) {
    ...
    return new ExecuteTriggerOrderLog(owner,
                                      market,
                                      entryPrice,
                                      entryPriceExponent,
                                      duration,
