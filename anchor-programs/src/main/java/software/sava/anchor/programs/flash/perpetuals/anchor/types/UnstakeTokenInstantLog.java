...
public record UnstakeTokenInstantLog(PublicKey owner,
  ...
  public static UnstakeTokenInstantLog read(final byte[] _data, final int offset) {
    ...
    return new UnstakeTokenInstantLog(owner,
                                      tokenStake,
                                      withdrawAmount,
                                      currentTimestamp,
