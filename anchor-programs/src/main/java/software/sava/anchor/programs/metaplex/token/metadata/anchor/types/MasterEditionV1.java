...
public record MasterEditionV1(PublicKey _address,
                              ...
                              PublicKey oneTimePrintingAuthorizationMint) implements Borsh {
  ...
  public static MasterEditionV1 read(final byte[] _data, final int offset) {
  ...
  public static MasterEditionV1 read(final PublicKey _address, final byte[] _data, final int offset) {
