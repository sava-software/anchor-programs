...
public record IncreaseSizeLogV4(PublicKey owner,
                                PublicKey market,
                                long entryPrice,
  ...
  public static IncreaseSizeLogV4 read(final byte[] _data, final int offset) {
    ...
    return new IncreaseSizeLogV4(owner,
                                 market,
                                 entryPrice,
                                 entryPriceExponent,
                                 deltaSizeAmount,
