...
public record RemoveCollateralLog(PublicKey owner,
                                  PublicKey market,
  ...
  public static RemoveCollateralLog read(final byte[] _data, final int offset) {
    ...
    return new RemoveCollateralLog(owner,
                                   market,
                                   collateralAmount,
                                   collateralPriceUsd);
  }
