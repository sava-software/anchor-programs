...
public record RemoveLiquidityLog(String poolName, byte[] _poolName,
                                 PublicKey owner,
                                 long custodyUid,
                                 long lpAmountIn,
                                 long amountOut,
  ...
  public static RemoveLiquidityLog createRecord(final String poolName,
                                                final PublicKey owner,
                                                final long custodyUid,
                                                final long lpAmountIn,
                                                final long amountOut,
                                                final long feeAmount) {
    return new RemoveLiquidityLog(poolName, poolName.getBytes(UTF_8),
                                  owner,
                                  custodyUid,
                                  lpAmountIn,
                                  amountOut,
  ...
  public static RemoveLiquidityLog read(final byte[] _data, final int offset) {
