...
public record ExecuteLimitOrderLog(PublicKey owner,
                                   PublicKey market,
                                   long entryPrice,
  ...
  public static ExecuteLimitOrderLog read(final byte[] _data, final int offset) {
    ...
    return new ExecuteLimitOrderLog(owner,
                                    market,
                                    entryPrice,
                                    entryPriceExponent,
                                    sizeAmount,
