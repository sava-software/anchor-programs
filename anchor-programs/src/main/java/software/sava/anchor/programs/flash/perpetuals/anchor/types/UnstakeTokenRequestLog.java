...
public record UnstakeTokenRequestLog(PublicKey owner,
  ...
  public static UnstakeTokenRequestLog read(final byte[] _data, final int offset) {
    ...
    return new UnstakeTokenRequestLog(owner,
                                      tokenStake,
                                      unstakeAmount,
                                      currentTimestamp,
