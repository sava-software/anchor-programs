...
public record PlaceLimitOrderLog(PublicKey owner,
                                 PublicKey market,
                                 long limitPrice,
  ...
  public static PlaceLimitOrderLog read(final byte[] _data, final int offset) {
    ...
    return new PlaceLimitOrderLog(owner,
                                  market,
                                  limitPrice,
                                  limitPriceExponent,
                                  sizeAmount,
