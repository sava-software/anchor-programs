...
public record SetCustomOraclePriceParams(long price,
                                         int expo,
                                         long conf,
                                         long ema,
  ...
  public static SetCustomOraclePriceParams read(final byte[] _data, final int offset) {
    ...
    return new SetCustomOraclePriceParams(price,
                                          expo,
                                          conf,
                                          ema,
                                          publishTime);
