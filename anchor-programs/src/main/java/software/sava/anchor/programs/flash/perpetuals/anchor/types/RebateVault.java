...
public record RebateVault(PublicKey _address,
  ...
  public static final int ALLOW_PAYOUT_OFFSET = 73;
  public static final int BUMP_OFFSET = 74;
  public static final int TOKEN_ACCOUNT_BUMP_OFFSET = 75;
  public static final int AVAILABLE_USD_OFFSET = 76;
  public static final int AVAILABLE_AMOUNT_OFFSET = 84;
  public static final int PADDING_OFFSET = 92;
  ...
  public static Filter createAllowPayoutFilter(final boolean allowPayout) {
    return Filter.createMemCompFilter(ALLOW_PAYOUT_OFFSET, new byte[]{(byte) (allowPayout ? 1 : 0)});
  }
  ...
  public static Filter createAvailableUsdFilter(final long availableUsd) {
    final byte[] _data = new byte[8];
    putInt64LE(_data, 0, availableUsd);
    return Filter.createMemCompFilter(AVAILABLE_USD_OFFSET, _data);
  }
  ...
  public static RebateVault read(final byte[] _data, final int offset) {
    return read(null, _data, offset);
  }

  public static RebateVault read(final AccountInfo<byte[]> accountInfo) {
    return read(accountInfo.pubKey(), accountInfo.data(), 0);
  }

  public static RebateVault read(final PublicKey _address, final byte[] _data) {
    return read(_address, _data, 0);
  }

  public static final BiFunction<PublicKey, byte[], RebateVault> FACTORY = RebateVault::read;

  public static RebateVault read(final PublicKey _address, final byte[] _data, final int offset) {
  ...
  public int write(final byte[] _data, final int offset) {
    ...
    ++i;
    _data[i] = (byte) (allowPayout ? 1 : 0);
    ++i;
    _data[i] = (byte) bump;
    ++i;
    _data[i] = (byte) tokenAccountBump;
    ++i;
    putInt64LE(_data, i, availableUsd);
    i += 8;
