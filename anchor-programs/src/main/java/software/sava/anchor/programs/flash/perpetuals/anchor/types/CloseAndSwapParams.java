...
public record CloseAndSwapParams(OraclePrice priceWithSlippage,
                                 long minSwapAmountOut,
                                 Privilege privilege) implements Borsh {

  public static final int BYTES = 21;

  public static CloseAndSwapParams read(final byte[] _data, final int offset) {
    ...
    return new CloseAndSwapParams(priceWithSlippage, minSwapAmountOut, privilege);
  }
