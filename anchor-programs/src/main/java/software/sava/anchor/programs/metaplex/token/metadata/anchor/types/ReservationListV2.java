...
public record ReservationListV2(PublicKey _address,
  ...
  public static ReservationListV2 read(final byte[] _data, final int offset) {
  ...
  public static ReservationListV2 read(final PublicKey _address, final byte[] _data, final int offset) {
