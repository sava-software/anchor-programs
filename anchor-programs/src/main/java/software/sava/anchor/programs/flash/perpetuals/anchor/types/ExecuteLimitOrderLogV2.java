...
public record ExecuteLimitOrderLogV2(PublicKey owner,
                                     PublicKey market,
                                     long entryPrice,
  ...
  public static ExecuteLimitOrderLogV2 read(final byte[] _data, final int offset) {
    ...
    return new ExecuteLimitOrderLogV2(owner,
                                      market,
                                      entryPrice,
                                      entryPriceExponent,
                                      sizeAmount,
