...
public sealed interface EngineFieldValue extends RustEnum permits
  ...
  record OracleConfigs(software.sava.anchor.programs.glam.protocol.anchor.types.OracleConfigs val) implements BorshEnum, EngineFieldValue {

    public static OracleConfigs read(final byte[] _data, final int offset) {
      return new OracleConfigs(software.sava.anchor.programs.glam.protocol.anchor.types.OracleConfigs.read(_data, offset));
    }
