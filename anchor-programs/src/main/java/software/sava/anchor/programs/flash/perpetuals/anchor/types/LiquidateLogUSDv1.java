...
public record LiquidateLogUSDv1(PublicKey owner,
                                PublicKey market,
                                long tradeId,
                                long entryPrice,
  ...
  public static LiquidateLogUSDv1 read(final byte[] _data, final int offset) {
    ...
    i += 8;
    final var penaltyUsd = getInt64LE(_data, i);
    i += 8;
    ...
    return new LiquidateLogUSDv1(owner,
                                 market,
                                 tradeId,
                                 entryPrice,
                                 entryPriceExponent,
