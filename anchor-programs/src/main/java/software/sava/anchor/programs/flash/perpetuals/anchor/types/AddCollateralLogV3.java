...
public record AddCollateralLogV3(PublicKey owner,
                                 PublicKey market,
  ...
  public static AddCollateralLogV3 read(final byte[] _data, final int offset) {
    ...
    return new AddCollateralLogV3(owner,
                                  market,
                                  collateralPrice,
