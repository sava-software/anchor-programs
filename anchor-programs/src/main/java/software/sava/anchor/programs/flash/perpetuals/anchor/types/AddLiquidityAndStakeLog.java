...
public record AddLiquidityAndStakeLog(String poolName, byte[] _poolName,
                                      PublicKey owner,
                                      long custodyUid,
                                      long amountIn,
                                      long lpAmountOut,
  ...
  public static AddLiquidityAndStakeLog createRecord(final String poolName,
    ...
    return new AddLiquidityAndStakeLog(poolName, poolName.getBytes(UTF_8),
                                       owner,
                                       custodyUid,
                                       amountIn,
                                       lpAmountOut,
  ...
  public static AddLiquidityAndStakeLog read(final byte[] _data, final int offset) {
