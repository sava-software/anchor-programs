...
public record DepositTokenStakeLog(PublicKey owner,
  ...
  public static DepositTokenStakeLog read(final byte[] _data, final int offset) {
    ...
    return new DepositTokenStakeLog(owner,
                                    tokenStake,
                                    depositAmount,
                                    currentTimestamp,
