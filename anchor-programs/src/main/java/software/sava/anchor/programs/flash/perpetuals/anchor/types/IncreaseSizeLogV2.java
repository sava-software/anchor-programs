...
public record IncreaseSizeLogV2(PublicKey owner,
                                PublicKey market,
                                long price,
                                int priceExponent,
                                long sizeAmount,
  ...
  public static IncreaseSizeLogV2 read(final byte[] _data, final int offset) {
    ...
    return new IncreaseSizeLogV2(owner,
                                 market,
                                 price,
                                 priceExponent,
                                 sizeAmount,
