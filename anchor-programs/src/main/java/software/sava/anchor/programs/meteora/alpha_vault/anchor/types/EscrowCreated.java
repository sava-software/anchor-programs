...
public record EscrowCreated(PublicKey vault,
                            PublicKey escrow,
                            PublicKey owner,
                            long vaultTotalEscrow,
                            long escrowFee) implements Borsh {

  public static final int BYTES = 112;

  public static EscrowCreated read(final byte[] _data, final int offset) {
    ...
    return new EscrowCreated(vault,
                             escrow,
                             owner,
                             vaultTotalEscrow,
                             escrowFee);
