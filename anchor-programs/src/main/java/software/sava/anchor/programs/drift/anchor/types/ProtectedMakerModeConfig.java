...
public record ProtectedMakerModeConfig(PublicKey _address,
  ...
  public static ProtectedMakerModeConfig read(final byte[] _data, final int offset) {
  ...
  public static ProtectedMakerModeConfig read(final PublicKey _address, final byte[] _data, final int offset) {
