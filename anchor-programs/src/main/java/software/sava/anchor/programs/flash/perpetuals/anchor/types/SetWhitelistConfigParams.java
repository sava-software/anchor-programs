...
public record SetWhitelistConfigParams(boolean isSwapFeeExempt,
  ...
  public static SetWhitelistConfigParams read(final byte[] _data, final int offset) {
    ...
    return new SetWhitelistConfigParams(isSwapFeeExempt,
                                        isDepositFeeExempt,
