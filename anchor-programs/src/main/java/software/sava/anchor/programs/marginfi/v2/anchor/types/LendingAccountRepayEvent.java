...
public record LendingAccountRepayEvent(AccountEventHeader header,
                                       PublicKey bank,
                                       PublicKey mint,
                                       long amount,
                                       boolean closeBalance) implements Borsh {

  public static LendingAccountRepayEvent read(final byte[] _data, final int offset) {
    ...
    return new LendingAccountRepayEvent(header,
                                        bank,
                                        mint,
                                        amount,
                                        closeBalance);
