...
public record ClosePositionLogV3(PublicKey owner,
                                 PublicKey market,
                                 long entryPrice,
  ...
  public static ClosePositionLogV3 read(final byte[] _data, final int offset) {
    ...
    return new ClosePositionLogV3(owner,
                                  market,
                                  entryPrice,
                                  entryPriceExponent,
                                  duration,
