...
public record PullFeedValueEvents(PublicKey[] feeds,
                                  PublicKey[] oracles,
                                  BigInteger[][] values,
                                  int reward) implements Borsh {

  public static PullFeedValueEvents read(final byte[] _data, final int offset) {
    ...
    return new PullFeedValueEvents(feeds,
                                   oracles,
                                   values,
                                   reward);
  }
