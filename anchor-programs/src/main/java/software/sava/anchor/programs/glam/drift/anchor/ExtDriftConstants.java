...
public final class ExtDriftConstants {

  public static final int PROTO_DRIFT_PROTOCOL = 1;
  ...
  public static final long PROTO_DRIFT_PROTOCOL_PERM_DEPOSIT = 8;
  ...
  public static final long PROTO_DRIFT_PROTOCOL_PERM_WITHDRAW = 16;

  public static final int PROTO_DRIFT_VAULTS = 2;

  public static final long PROTO_DRIFT_VAULTS_PERM_DEPOSIT = 1;

  public static final long PROTO_DRIFT_VAULTS_PERM_WITHDRAW = 2;

  private ExtDriftConstants() {
  }
}
