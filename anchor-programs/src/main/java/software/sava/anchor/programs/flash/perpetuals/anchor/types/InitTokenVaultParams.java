...
public record InitTokenVaultParams(TokenPermissions tokenPermissions,
                                   long amount,
  ...
  public static InitTokenVaultParams read(final byte[] _data, final int offset) {
    ...
    return new InitTokenVaultParams(tokenPermissions,
                                    amount,
                                    withdrawTimeLimit,
                                    withdrawInstantFee,
                                    stakeLevel);
