...
public record RemoveCollateralLogV2(PublicKey owner,
                                    PublicKey market,
                                    long collateralAmount,
                                    long collateralPrice,
                                    int collateralPriceExponent) implements Borsh {

  public static final int BYTES = 84;

  public static RemoveCollateralLogV2 read(final byte[] _data, final int offset) {
    ...
    return new RemoveCollateralLogV2(owner,
                                     market,
                                     collateralAmount,
                                     collateralPrice,
