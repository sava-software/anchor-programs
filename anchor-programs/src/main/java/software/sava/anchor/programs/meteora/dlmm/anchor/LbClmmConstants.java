...
public final class LbClmmConstants {
  ...
  public static final byte[] CLAIM_PROTOCOL_FEE_OPERATOR = new byte[]{99, 102, 95, 111, 112, 101, 114, 97, 116, 111, 114};

  public static final long DEFAULT_BIN_PER_POSITION = 70;
  ...
  public static final BigInteger MINIMUM_LIQUIDITY = new BigInteger("1000000");
  ...
  public static final long POSITION_MAX_LENGTH = 1400;

  public static final byte[] PRESET_PARAMETER = new byte[]{112, 114, 101, 115, 101, 116, 95, 112, 97, 114, 97, 109, 101, 116, 101, 114};

  public static final byte[] PRESET_PARAMETER2 = new byte[]{112, 114, 101, 115, 101, 116, 95, 112, 97, 114, 97, 109, 101, 116, 101, 114, 50};

  public static final int PROTOCOL_SHARE = 500;
