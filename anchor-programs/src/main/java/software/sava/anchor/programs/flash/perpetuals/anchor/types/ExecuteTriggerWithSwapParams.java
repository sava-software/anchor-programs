...
public record ExecuteTriggerWithSwapParams(boolean isStopLoss,
                                           int orderId,
                                           Privilege privilege) implements Borsh {

  public static final int BYTES = 3;

  public static ExecuteTriggerWithSwapParams read(final byte[] _data, final int offset) {
    ...
    return new ExecuteTriggerWithSwapParams(isStopLoss, orderId, privilege);
  }
