...
public record SwapAndOpenLog(String poolName, byte[] _poolName,
                             PublicKey owner,
                             ...
                             int targetOracleAccountPriceExponent) implements Borsh {

  public static SwapAndOpenLog createRecord(final String poolName,
    ...
    return new SwapAndOpenLog(poolName, poolName.getBytes(UTF_8),
                              owner,
                              receivingCustodyUid,
  ...
  public static SwapAndOpenLog read(final byte[] _data, final int offset) {
