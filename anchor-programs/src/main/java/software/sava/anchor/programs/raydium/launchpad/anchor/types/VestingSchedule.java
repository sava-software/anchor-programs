...
public record VestingSchedule(long totalLockedAmount,
                              long cliffPeriod,
                              long unlockPeriod,
                              long startTime,
                              // Total allocated share amount of the base token, not greater than total_locked_amount
                              long allocatedShareAmount) implements Borsh {

  public static final int BYTES = 40;

  public static VestingSchedule read(final byte[] _data, final int offset) {
    ...
    i += 8;
    final var allocatedShareAmount = getInt64LE(_data, i);
    return new VestingSchedule(totalLockedAmount,
                               cliffPeriod,
                               unlockPeriod,
                               startTime,
  ...
  public int write(final byte[] _data, final int offset) {
    ...
    i += 8;
    putInt64LE(_data, i, allocatedShareAmount);
    i += 8;
    return i - offset;
  }
