...
public record WhirlpoolStatePositionPositionRewardInfo(BigInteger growthInsideCheckpoint, long amountOwed) implements Borsh {

  public static final int BYTES = 24;

  public static WhirlpoolStatePositionPositionRewardInfo read(final byte[] _data, final int offset) {
