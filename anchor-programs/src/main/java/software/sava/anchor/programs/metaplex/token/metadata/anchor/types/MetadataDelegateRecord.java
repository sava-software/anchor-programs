...
public record MetadataDelegateRecord(PublicKey _address,
  ...
  public static MetadataDelegateRecord read(final byte[] _data, final int offset) {
  ...
  public static MetadataDelegateRecord read(final PublicKey _address, final byte[] _data, final int offset) {
