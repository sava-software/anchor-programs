...
public record FixedCurve(long supply,
                         long totalQuoteFundRaising,
                         int migrateType) implements Borsh {

  public static final int BYTES = 17;

  public static FixedCurve read(final byte[] _data, final int offset) {
    ...
    return new FixedCurve(supply, totalQuoteFundRaising, migrateType);
  }
