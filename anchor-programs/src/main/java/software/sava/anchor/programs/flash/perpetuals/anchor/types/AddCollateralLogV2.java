...
public record AddCollateralLogV2(PublicKey owner,
                                 PublicKey market,
  ...
  public static AddCollateralLogV2 read(final byte[] _data, final int offset) {
    ...
    return new AddCollateralLogV2(owner,
                                  market,
                                  collateralAmount,
                                  collateralPrice,
