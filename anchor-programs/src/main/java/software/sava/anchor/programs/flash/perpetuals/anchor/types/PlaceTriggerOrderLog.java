...
public record PlaceTriggerOrderLog(PublicKey owner,
                                   PublicKey market,
                                   long price,
                                   int priceExponent,
                                   long sizeAmount,
  ...
  public static PlaceTriggerOrderLog read(final byte[] _data, final int offset) {
    ...
    return new PlaceTriggerOrderLog(owner,
                                    market,
                                    price,
                                    priceExponent,
                                    sizeAmount,
