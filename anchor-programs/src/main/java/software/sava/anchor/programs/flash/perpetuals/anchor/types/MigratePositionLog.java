...
public record MigratePositionLog(PublicKey owner,
                                 PublicKey market,
                                 PublicKey position,
                                 long entryPrice,
  ...
  public static MigratePositionLog read(final byte[] _data, final int offset) {
    ...
    return new MigratePositionLog(owner,
                                  market,
                                  position,
                                  entryPrice,
                                  entryPriceExponent,
