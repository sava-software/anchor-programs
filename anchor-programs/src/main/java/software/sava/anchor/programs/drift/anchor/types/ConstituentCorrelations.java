...
public record ConstituentCorrelations(PublicKey _address,
  ...
  public static ConstituentCorrelations read(final byte[] _data, final int offset) {
  ...
  public static ConstituentCorrelations read(final PublicKey _address, final byte[] _data, final int offset) {
