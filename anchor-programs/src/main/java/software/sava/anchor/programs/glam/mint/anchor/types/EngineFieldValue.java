...
public sealed interface EngineFieldValue extends RustEnum permits
  ...
  record FeeStructure(software.sava.anchor.programs.glam.mint.anchor.types.FeeStructure val) implements BorshEnum, EngineFieldValue {
    ...
    public static FeeStructure read(final byte[] _data, final int offset) {
      return new FeeStructure(software.sava.anchor.programs.glam.mint.anchor.types.FeeStructure.read(_data, offset));
    }
  ...
  record FeeParams(software.sava.anchor.programs.glam.mint.anchor.types.FeeParams val) implements BorshEnum, EngineFieldValue {

    public static FeeParams read(final byte[] _data, final int offset) {
      return new FeeParams(software.sava.anchor.programs.glam.mint.anchor.types.FeeParams.read(_data, offset));
    }
  ...
  record AccruedFees(software.sava.anchor.programs.glam.mint.anchor.types.AccruedFees val) implements BorshEnum, EngineFieldValue {

    public static AccruedFees read(final byte[] _data, final int offset) {
      return new AccruedFees(software.sava.anchor.programs.glam.mint.anchor.types.AccruedFees.read(_data, offset));
    }
  ...
  record NotifyAndSettle(software.sava.anchor.programs.glam.mint.anchor.types.NotifyAndSettle val) implements BorshEnum, EngineFieldValue {

    public static NotifyAndSettle read(final byte[] _data, final int offset) {
      return new NotifyAndSettle(software.sava.anchor.programs.glam.mint.anchor.types.NotifyAndSettle.read(_data, offset));
    }
  ...
  record OracleConfigs(software.sava.anchor.programs.glam.mint.anchor.types.OracleConfigs val) implements BorshEnum, EngineFieldValue {

    public static OracleConfigs read(final byte[] _data, final int offset) {
      return new OracleConfigs(software.sava.anchor.programs.glam.mint.anchor.types.OracleConfigs.read(_data, offset));
    }
