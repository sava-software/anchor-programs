...
public record ConstituentTargetBase(PublicKey _address,
  ...
  public static ConstituentTargetBase read(final byte[] _data, final int offset) {
  ...
  public static ConstituentTargetBase read(final PublicKey _address, final byte[] _data, final int offset) {
