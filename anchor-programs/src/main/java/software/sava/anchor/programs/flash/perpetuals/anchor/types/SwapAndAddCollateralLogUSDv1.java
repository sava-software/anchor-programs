...
public record SwapAndAddCollateralLogUSDv1(PublicKey owner,
                                           PublicKey market,
                                           long tradeId,
                                           int inputCustodyUid,
                                           long inputPrice,
                                           int inputPriceExponent,
                                           long deltaInputAmount,
  ...
  public static SwapAndAddCollateralLogUSDv1 read(final byte[] _data, final int offset) {
    ...
    i += 4;
    final var deltaInputAmount = getInt64LE(_data, i);
    i += 8;
    ...
    return new SwapAndAddCollateralLogUSDv1(owner,
                                            market,
                                            tradeId,
                                            inputCustodyUid,
                                            inputPrice,
  ...
  public int write(final byte[] _data, final int offset) {
    ...
    i += 4;
    putInt64LE(_data, i, deltaInputAmount);
    i += 8;
