...
public record CommonFields(long slot,
                           long unixTimestamp,
                           long launchSeqNum) implements Borsh {
  ...
  public static CommonFields read(final byte[] _data, final int offset) {
    ...
    i += 8;
    final var launchSeqNum = getInt64LE(_data, i);
    return new CommonFields(slot, unixTimestamp, launchSeqNum);
  }
  ...
  public int write(final byte[] _data, final int offset) {
    ...
    i += 8;
    putInt64LE(_data, i, launchSeqNum);
    i += 8;
    return i - offset;
  }
