...
public record CollectRevenueLog(PublicKey owner,
  ...
  public static CollectRevenueLog read(final byte[] _data, final int offset) {
    ...
    return new CollectRevenueLog(owner,
                                 tokenStake,
                                 revenueAmount,
                                 lastEpochCount,
                                 padding);
