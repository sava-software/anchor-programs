...
public record SwapAndAddCollateralLog(PublicKey owner,
                                      PublicKey market,
  ...
  public static SwapAndAddCollateralLog read(final byte[] _data, final int offset) {
    ...
    return new SwapAndAddCollateralLog(owner,
                                       market,
                                       receivingCustodyUid,
                                       receiveAmount,
                                       swapFeeAmount,
