...
public record CancelLimitOrderLog(PublicKey owner,
                                  PublicKey market,
                                  long limitPrice,
  ...
  public static CancelLimitOrderLog read(final byte[] _data, final int offset) {
    ...
    return new CancelLimitOrderLog(owner,
                                   market,
                                   limitPrice,
                                   limitPriceExponent,
                                   sizeAmount,
