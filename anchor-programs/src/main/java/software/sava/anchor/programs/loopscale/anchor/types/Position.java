...
public record Position(PublicKey _address,
                       ...
                       long feeOwedB,
                       WhirlpoolStatePositionPositionRewardInfo[] rewardInfos) implements Borsh {
  ...
  public static Position read(final PublicKey _address, final byte[] _data, final int offset) {
    ...
    Borsh.readArray(rewardInfos, WhirlpoolStatePositionPositionRewardInfo::read, _data, i);
