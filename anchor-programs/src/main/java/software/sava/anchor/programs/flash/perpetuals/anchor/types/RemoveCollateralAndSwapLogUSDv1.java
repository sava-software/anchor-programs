...
public record RemoveCollateralAndSwapLogUSDv1(PublicKey owner,
                                              PublicKey market,
                                              long tradeId,
  ...
  public static RemoveCollateralAndSwapLogUSDv1 read(final byte[] _data, final int offset) {
    ...
    return new RemoveCollateralAndSwapLogUSDv1(owner,
                                               market,
                                               tradeId,
                                               collateralPrice,
