...
public record ExecuteTriggerOrderLogUSDv1(PublicKey owner,
                                          PublicKey market,
                                          long tradeId,
                                          long entryPrice,
  ...
  public static ExecuteTriggerOrderLogUSDv1 read(final byte[] _data, final int offset) {
    ...
    return new ExecuteTriggerOrderLogUSDv1(owner,
                                           market,
                                           tradeId,
                                           entryPrice,
                                           entryPriceExponent,
