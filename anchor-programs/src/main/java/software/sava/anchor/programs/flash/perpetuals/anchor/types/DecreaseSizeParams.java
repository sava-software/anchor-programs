...
public record DecreaseSizeParams(OraclePrice priceWithSlippage,
                                 long sizeDelta,
                                 Privilege privilege) implements Borsh {

  public static final int BYTES = 21;

  public static DecreaseSizeParams read(final byte[] _data, final int offset) {
    ...
    return new DecreaseSizeParams(priceWithSlippage, sizeDelta, privilege);
  }
