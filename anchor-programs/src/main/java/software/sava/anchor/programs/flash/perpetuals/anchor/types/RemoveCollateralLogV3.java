...
public record RemoveCollateralLogV3(PublicKey owner,
                                    PublicKey market,
  ...
  public static RemoveCollateralLogV3 read(final byte[] _data, final int offset) {
    ...
    return new RemoveCollateralLogV3(owner,
                                     market,
                                     collateralPrice,
