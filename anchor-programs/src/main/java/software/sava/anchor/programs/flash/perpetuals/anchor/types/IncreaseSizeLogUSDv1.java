...
public record IncreaseSizeLogUSDv1(PublicKey owner,
                                   PublicKey market,
                                   long tradeId,
                                   long entryPrice,
  ...
  public static IncreaseSizeLogUSDv1 read(final byte[] _data, final int offset) {
    ...
    return new IncreaseSizeLogUSDv1(owner,
                                    market,
                                    tradeId,
                                    entryPrice,
                                    entryPriceExponent,
