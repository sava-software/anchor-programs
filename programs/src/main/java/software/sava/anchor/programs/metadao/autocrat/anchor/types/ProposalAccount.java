...
public record ProposalAccount(PublicKey pubkey,
                              boolean isSigner,
                              boolean isWritable) implements Borsh {

  public static final int BYTES = 34;

  public static ProposalAccount read(final byte[] _data, final int offset) {
    ...
    return new ProposalAccount(pubkey, isSigner, isWritable);
  }
