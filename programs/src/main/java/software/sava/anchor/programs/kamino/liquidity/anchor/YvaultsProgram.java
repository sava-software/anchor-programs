...
public final class YvaultsProgram {
  ...
  public static final Discriminator SWAP_UNEVEN_VAULTS_DISCRIMINATOR = toDiscriminator(143, 212, 101, 95, 105, 209, 184, 1);

  public static Instruction swapUnevenVaults(final AccountMeta invokedYvaultsProgramMeta,
                                             final PublicKey actionsAuthorityKey,
                                             final PublicKey strategyKey,
                                             final PublicKey globalConfigKey,
                                             final PublicKey tokenAVaultKey,
                                             final PublicKey tokenBVaultKey,
                                             ...
                                             final PublicKey poolKey,
                                             final PublicKey positionKey,
                                             final PublicKey raydiumPoolConfigOrBaseVaultAuthorityKey,
                                             final PublicKey poolTokenVaultAKey,
                                             final PublicKey poolTokenVaultBKey,
    ...
    final var keys = List.of(
      createWritableSigner(actionsAuthorityKey),
      createWrite(strategyKey),
      createRead(globalConfigKey),
      createWrite(tokenAVaultKey),
      createWrite(tokenBVaultKey),
      ...
      createWrite(poolKey),
      createWrite(positionKey),
      createRead(raydiumPoolConfigOrBaseVaultAuthorityKey),
      createWrite(poolTokenVaultAKey),
      createWrite(poolTokenVaultBKey),
    ...
    final byte[] _data = new byte[16];
    int i = writeDiscriminator(SWAP_UNEVEN_VAULTS_DISCRIMINATOR, _data, 0);
  ...
  public record SwapUnevenVaultsIxData(Discriminator discriminator, long targetLimitBps) implements Borsh {  
    ...
    public static SwapUnevenVaultsIxData read(final byte[] _data, final int offset) {
      if (_data == null || _data.length == 0) {
        return null;
      }
      final var discriminator = parseDiscriminator(_data, offset);
      ...
      return new SwapUnevenVaultsIxData(discriminator, targetLimitBps);
    }
