...
public record State(PublicKey _address,
  ...
  public static final int BYTES = 488;
  ...
  public static final int SPOT_FEE_STRUCTURE_OFFSET = 264;
  public static final int ORACLE_GUARD_RAILS_OFFSET = 360;
  public static final int NUMBER_OF_AUTHORITIES_OFFSET = 432;
  public static final int NUMBER_OF_SUB_ACCOUNTS_OFFSET = 440;
  public static final int LP_COOLDOWN_TIME_OFFSET = 448;
  public static final int LIQUIDATION_MARGIN_BUFFER_RATIO_OFFSET = 456;
  public static final int SETTLEMENT_DURATION_OFFSET = 460;
  public static final int NUMBER_OF_MARKETS_OFFSET = 462;
  public static final int NUMBER_OF_SPOT_MARKETS_OFFSET = 464;
  public static final int SIGNER_NONCE_OFFSET = 466;
  public static final int MIN_PERP_AUCTION_DURATION_OFFSET = 467;
  public static final int DEFAULT_MARKET_ORDER_TIME_IN_FORCE_OFFSET = 468;
  public static final int DEFAULT_SPOT_AUCTION_DURATION_OFFSET = 469;
  public static final int EXCHANGE_STATUS_OFFSET = 470;
  public static final int LIQUIDATION_DURATION_OFFSET = 471;
  public static final int INITIAL_PCT_TO_LIQUIDATE_OFFSET = 472;
