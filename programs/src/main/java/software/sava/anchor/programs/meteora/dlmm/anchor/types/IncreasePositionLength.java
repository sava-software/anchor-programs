...
public record IncreasePositionLength(PublicKey lbPair,
                                     PublicKey position,
                                     PublicKey owner,
                                     int lengthToAdd,
  ...
  public static IncreasePositionLength read(final byte[] _data, final int offset) {
    ...
    return new IncreasePositionLength(lbPair,
                                      position,
                                      owner,
                                      lengthToAdd,
                                      side);
