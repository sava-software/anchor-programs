...
public record SplitTokensEvent(CommonFields common,
                               PublicKey user,
                               PublicKey vault,
                               long amount,
  ...
  public static SplitTokensEvent read(final byte[] _data, final int offset) {
    ...
    return new SplitTokensEvent(common,
                                user,
                                vault,
                                amount,
