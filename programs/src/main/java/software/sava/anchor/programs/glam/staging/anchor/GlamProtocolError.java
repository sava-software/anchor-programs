...
public sealed interface GlamProtocolError extends ProgramError permits
    ...
    GlamProtocolError.SubscribeRedeemDisabled,
    GlamProtocolError.InvalidAssetSubscribe,
  ...
  static GlamProtocolError getInstance(final int errorCode) {
    return switch (errorCode) {
      ...
      case 51002 -> SubscribeRedeemDisabled.INSTANCE;
      case 51003 -> InvalidAssetSubscribe.INSTANCE;
  ...
  record SubscribeRedeemDisabled(int code, String msg) implements GlamProtocolError {

    public static final SubscribeRedeemDisabled INSTANCE = new SubscribeRedeemDisabled(
        51002, "Subscription and redemption disabled"
    );
  }

  record InvalidAssetSubscribe(int code, String msg) implements GlamProtocolError {
