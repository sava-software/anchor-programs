...
public record ReallocStakeListEvent(PublicKey state,
                                    int count,
                                    int newCapacity) implements Borsh {

  public static final int BYTES = 40;

  public static ReallocStakeListEvent read(final byte[] _data, final int offset) {
    ...
    return new ReallocStakeListEvent(state, count, newCapacity);
  }
