...
public record OrderActionRecord(long ts,
  ...
  public int l() {
    return 8
         ...
         + (fillerReward == null || fillerReward.isEmpty() ? 1 : 9)
         + (fillRecordId == null || fillRecordId.isEmpty() ? 1 : 9)
         + (baseAssetAmountFilled == null || baseAssetAmountFilled.isEmpty() ? 1 : 9)
         + (quoteAssetAmountFilled == null || quoteAssetAmountFilled.isEmpty() ? 1 : 9)
         + (takerFee == null || takerFee.isEmpty() ? 1 : 9)
         + (makerFee == null || makerFee.isEmpty() ? 1 : 9)
         + (referrerReward == null || referrerReward.isEmpty() ? 1 : 5)
         + (quoteAssetAmountSurplus == null || quoteAssetAmountSurplus.isEmpty() ? 1 : 9)
         + (spotFulfillmentMethodFee == null || spotFulfillmentMethodFee.isEmpty() ? 1 : 9)
         + Borsh.lenOptional(taker, 32)
         + (takerOrderId == null || takerOrderId.isEmpty() ? 1 : 5)
         + Borsh.lenOptional(takerOrderDirection)
         + (takerOrderBaseAssetAmount == null || takerOrderBaseAssetAmount.isEmpty() ? 1 : 9)
         + (takerOrderCumulativeBaseAssetAmountFilled == null || takerOrderCumulativeBaseAssetAmountFilled.isEmpty() ? 1 : 9)
         + (takerOrderCumulativeQuoteAssetAmountFilled == null || takerOrderCumulativeQuoteAssetAmountFilled.isEmpty() ? 1 : 9)
         + Borsh.lenOptional(maker, 32)
         + (makerOrderId == null || makerOrderId.isEmpty() ? 1 : 5)
         + Borsh.lenOptional(makerOrderDirection)
         + (makerOrderBaseAssetAmount == null || makerOrderBaseAssetAmount.isEmpty() ? 1 : 9)
         + (makerOrderCumulativeBaseAssetAmountFilled == null || makerOrderCumulativeBaseAssetAmountFilled.isEmpty() ? 1 : 9)
         + (makerOrderCumulativeQuoteAssetAmountFilled == null || makerOrderCumulativeQuoteAssetAmountFilled.isEmpty() ? 1 : 9)
         + 8;
  }
}
