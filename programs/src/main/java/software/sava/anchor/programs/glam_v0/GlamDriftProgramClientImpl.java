...
final class GlamDriftProgramClientImpl implements GlamDriftProgramClient {
  ...
  private static software.sava.anchor.programs.glam_v0.anchor.types.OrderParams toGlam(final OrderParams orderParams) {
    return new software.sava.anchor.programs.glam_v0.anchor.types.OrderParams(
  ...
  private static software.sava.anchor.programs.glam_v0.anchor.types.OrderParams[] toGlam(final OrderParams[] orderParamsArray) {
    final var glamOrderParams = new software.sava.anchor.programs.glam_v0.anchor.types.OrderParams[orderParamsArray.length];
