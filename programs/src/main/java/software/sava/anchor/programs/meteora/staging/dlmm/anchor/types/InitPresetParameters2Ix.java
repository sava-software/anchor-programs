...
public record InitPresetParameters2Ix(int index,
  ...
  public static InitPresetParameters2Ix read(final byte[] _data, final int offset) {
    ...
    return new InitPresetParameters2Ix(index,
                                       binStep,
                                       baseFactor,
                                       filterPeriod,
                                       decayPeriod,
